  ...
  return (
    <div className="min-h-screen bg-white-soft text-brown-mid">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-24">
        ...
        <h1 className="font-['Playfair_Display',serif] text-4xl font-bold text-brown-deep mb-8">Privacy Policy</h1>
        <div className="space-y-6 text-brown-mid leading-relaxed">
          <p><strong className="text-brown-deep">Last updated:</strong> July 2026</p>
          <h2 className="text-xl font-semibold text-brown-deep mt-8">1. Information We Collect</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">2. How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">3. Data Security</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">4. Third-Party Services</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">5. Contact</h2>
