  ...
  return (
    <div className="min-h-screen bg-[#0D0D12] text-[#E4E4E7]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-24">
        ...
        <h1 className="font-['Playfair_Display',serif] text-4xl font-bold text-white mb-8">Terms of Service</h1>
        <div className="space-y-6 text-[#A1A1AA] leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-white mt-8">2. Products & Pricing</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8">3. Shipping & Delivery</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8">4. Returns & Refunds</h2>
