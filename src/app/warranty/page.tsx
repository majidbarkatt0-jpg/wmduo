  ...
  return (
    <div className="min-h-screen bg-white-soft text-brown-mid">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-24">
        ...
        <h1 className="font-['Playfair_Display',serif] text-4xl font-bold text-brown-deep mb-8">Returns & Warranty</h1>
        <div className="space-y-6 text-brown-mid leading-relaxed">
          <h2 className="text-xl font-semibold text-brown-deep mt-4">30-Day Money-Back Guarantee</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">Return Process</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">2-Year Warranty</h2>
          ...
          <h2 className="text-xl font-semibold text-brown-deep mt-8">Warranty Claims</h2>
